...
class TestSync(unittest.TestCase):
    ...
    @patch("tap_sendwithus.streams.abstracts.ParentBaseStream.is_selected", return_value=True)
    @patch("tap_sendwithus.streams.abstracts.ParentBaseStream.get_bookmark", return_value=100)
