...
- Pulls raw data from the [sendwithus API](https://support.sendwithus.com/api/).
- Extracts the following resources:
    - [Templates](https://support.sendwithus.com/api/#getalistoftemplates)

    - [Logs](https://support.sendwithus.com/api/#logsapi)

    - [LogEvents](https://support.sendwithus.com/api/#retrieveeventsforaspecificlog_id.)

    - [Snippets](https://support.sendwithus.com/api/#getallsnippets)

    - [DripCampaigns](https://support.sendwithus.com/api/#getalistofcampaigns)
...
**[drip_campaigns](https://support.sendwithus.com/api/#getalistofcampaigns)**
- Primary keys: ['id']
...
6. Test the Tap
    While developing the sendwithus tap, the following utilities were run in accordance with Singer.io best practices:
